...
public class Camera2BasicFragment extends Fragment
    ...
    public static boolean mAutoFocusSupported;
    ...
    private static Size chooseOptimalSize(Size[] choices, int textureViewWidth,
        ...
        if (bigEnough.size() > 0) {
            ...
            Log.e(TAG, "No se pudo encontrar una medida adecuada");
            return choices[0];
        }
    }
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                System.out.println("ids de la camara: " + cameraId);

                // We don't use a front facing camera in this sample.
                Integer facing = characteristics.get(CameraCharacteristics.LENS_FACING);
                System.out.println("El numero del id del facin es: " + facing);

                if (facing != null && facing == CameraCharacteristics.LENS_FACING_FRONT) {
                    System.out.println("Entro al If del facing");
                    continue;
                }
                ...
                //si se setea a uno abre la frontal pero no guarda la imagen
                mCameraId = "1";
                return;
            }
    ...
    private void takePicture() {
        //AQUI AGREGAR LAS VALIDACIONES DEL STACK
        //
       /*
       * if (mAutoFocusSupported) {
       ...
       //AQUI MISMO SE AGREGA LO DE LAS COORDENADAS
        ...
        try {
            ...
            CameraCaptureSession.CaptureCallback CaptureCallback
                ...
                public void onCaptureCompleted(@NonNull CameraCaptureSession session,
                                               @NonNull CaptureRequest request,
                                               @NonNull TotalCaptureResult result) {
                    showToast("Imagen guardada: " + mFile);
